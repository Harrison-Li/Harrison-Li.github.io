...
I further integrated this knowledge into large language models, enabling the system to provide experimental guidance and analyze correlations between material choices, device structures, and performance. Finally, the model can search for precursor suppliers and retrosynthesis plan for new candidates.

GitHub repository code will be released soon after manucript submission. (update: I pre-release the experimental code. Please check on https://github.com/Harrison-Li/Perovskite-MutiAI-Agent)
![alt text](assets/image-20250712185319106.png)
